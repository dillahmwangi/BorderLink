...
<div class="bg-gray-100">
    <div class="container mx-auto py-8 px-4 pt-12  sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                ...
                <div class="bg-white shadow rounded-lg p-8">
                    <div class="flex flex-col items-center">
                        ...
                        <div class="mt-6 flex flex-wrap gap-4 justify-center">
                            <a href="#" class="bg-gray-900 hover:bg-gray-600 text-white py-2 px-4 rounded">Contact</a>
                            <a href="#" class="bg-gray-900 hover:bg-gray-600 text-white py-2 px-4 rounded">Resume</a>
                        </div>
                    </div>
