          ...
          <div className=" px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="relative flex items-center justify-between ">
              ...
              >
                ...
                <span className="ml-2 text-md font-bold tracking-wide text-gray-100 uppercase ">
              ...
              <ul className="flex items-center  space-x-8 lg:flex">
                <li>
                  <Link
                    ...
                    title="Our product"
                    className="font-medium tracking-wide text-gray-100 active:text-gray-200 hover:text-gray-500 transition-colors duration-200 "
                  >
                    Home
                  </Link>
                </li>
              ...
              <ul className="flex items-center  space-x-8 lg:flex">
                <li className='text-white hover:text-gray-400'>
                  ...
                  <Icon icon='mdi:bell-notification'width={24} height={24} /> 
                 
                </li> 
                <li className='text-white hover:text-gray-400'>
                <Link to='/chat'>
                  <Icon icon='bi:chat-dots-fill' width={24} height={24} />
                  </Link>
                </li>
                <li className='text-white hover:text-gray-400'>
                <Link to='/profile'>
